    ...
    >
      ...
      <div className="mt-20">
        {/* <div className="relative ">
          ...
          />
          <Heart classNames="absolute top-4 right-4 w-6 h-6 fill-blue" filled={true}/>
        </div> */}
        <LikeableImage
          alt="Big Modern House with Swiming Pool"
          className="h-89 rounded-lg object-center object-cover w-full"
        ...
        <div className="md:grid md:grid-cols-2 mt-4 gap-4">
          ...
          <div className="flex flex-col mt-4 md:mt-0">
            <LikeableImage
              className="sm:h-60 md:h-[550px] lg:h-[795px] rounded-lg object-center object-cover w-full"
